        ...
        <div class="flex items-start space-x-4 rtl:space-x-reverse">
            ...
            <div class="flex-1 min-w-0 ">
                <p class="text-sm font-bold text-gray-900 truncate dark:text-white">
                    {{ ucWords($item->absenkaryawandetail->absenkaryawan->user->name) }}
                </p>
                <p class="text-sm text-gray-500 truncate dark:text-white">
                    Type : <span class="font-medium text-gray-800">{{ strtoupper(str_replace('_',' ',$item->absenkaryawandetail->type)) }}</span>
                </p>
