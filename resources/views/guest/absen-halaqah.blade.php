<x-absen>
    ...
    <div class="relative flex flex-col justify-center gap-3 mt-4 ">
        ...
        <div x-data="{camera:true}">
            ...
            <div class="relative my-4">
                <div class="absolute top-0 right-0 px-4 py-4 bg-white bg-opacity-50 rounded-bl-xl">
                    <p class="text-sm text-red-800">{{ ucWords(strtolower($jadwal->nama_sesi)) }}</p>
                </div>
                <div x-show="camera">
    ...
    <div class="w-full sm:max-w-md">
        <form id="form_store" method="POST" action="{{route('absen-halaqah.store')}}">
            @csrf
