<x-absen>
    ...
    <div class="relative flex flex-col justify-center gap-3 mt-4 ">
        ...
        <div x-data="{camera:true}">
            ...
            <div class="my-4">
                <div x-show="camera" class="flex justify-center">
                    <div id="my_camera" class="flex justify-center mx-auto overflow-hidden text-center shadow-lg rounded-xl"></div>
                </div>
                <div x-show="!camera">
        ...
        <div class="w-full px-4 sm:max-w-md">
            <form id="form_store" method="POST" action="{{ route('v2.dinasluar.store',$absen_type) }}">
                @csrf
                ...
                <div class="relative">
                    <textarea name="keterangan" id="input-group-1" cols="30" rows="2"  class="text-sm bg-gray-50 bg-opacity-60 border border-red-600 ring-1 ring-offset-2 ring-red-600 text-gray-900 rounded-xl focus:ring-red-500 focus:border-red-500 block w-full  px-2.5  py-3 dark:bg-gray-700 text-center dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" placeholder="Tuliskan Catatan / Alasan Melakukan Absen tugas dinas diluar lingkungan pesantren"></textarea>
                </div>
