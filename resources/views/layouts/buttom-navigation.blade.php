<div class="fixed bottom-0 z-50 w-full h-16 -translate-x-1/2 bg-white border-t border-red-400 rounded-t-2xl left-1/2 sm:max-w-md dark:bg-gray-700 dark:border-gray-600">
