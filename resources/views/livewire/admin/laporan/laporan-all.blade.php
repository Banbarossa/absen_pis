                ...
                <div class="card m-b-30">
                    <div class="card-body">
                        <div class="">
                            <div class="row">
                                <div class="col-12">
                                    <h4 class="mt-0 header-title">Rekap Kehadiran Guru Mengajar</h4>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-lg-6 d-flex gap-3">
                                    <button type="button" class="btn btn-sm btn-primary mr-2 waves-effect waves-light align-self-center" data-toggle="modal" data-animation="bounce" data-target=".bs-example-modal-lg">Unduh Rekap Kehadiran</button>
                            ...
                            <table class="table table-sm table-bordered ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $summary['unique_hadir_dates']  ==0 ?'':$summary['unique_hadir_dates'].' hari'}}</td>
            ...
            <div class="col-lg-4">
                <div class="card m-b-30 p-4">
                    <div class="card-header">
                        <h4 class="mt-0 header-title">Rekap Kehadiran</strong></h4>
                    </div>
                    <div class="card-body">
                        <table class="table">
                            <tbody>
