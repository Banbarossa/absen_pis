<aside class="px-3 py-6 bg-white divide-y-2 md:fixed md:top-20 md:min-w-24 md:w-32 rounded-xl dark:bg-gray-800">
    <ul class="grid grid-cols-3 gap-2 text-xs font-medium md:space-y-2 md:grid-cols-1">
        ...
        {{-- <x-sidebar-link :href="route('v2.profile')" :active="Request::routeIs('v2.profile')" label="Profile">
            <svg class="w-5 h-5 {{ Request::routeIs('v2.profile') ?  'text-red-900' :'text-gray-500'}}  transition duration-75 dark:text-red-400 group-hover:text-red-900 dark:group-hover:text-white"
                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                viewBox="0 0 22 21">
                <path
                    d="M16.975 11H10V4.025a1 1 0 0 0-1.066-.998 8.5 8.5 0 1 0 9.039 9.039.999.999 0 0 0-1-1.066h.002Z" />
