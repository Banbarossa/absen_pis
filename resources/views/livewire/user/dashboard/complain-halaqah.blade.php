<div class="w-full p-4 text-xs bg-white rounded-lg md:text-sm md:w-1/2">
    ...
    <form action="" wire:submit.prevent='store'>
        ...
        <div>
            <select id="change_to" wire:model='change_to' class="bg-gray-50 border text-xs md:text-sm border-gray-300 text-gray-900 rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 ">
